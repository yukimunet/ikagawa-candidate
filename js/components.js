riot.tag('app-events', '<article each="{ props }"> <h3><fa icon="bullhorn"></fa>{ title }</h3> <time datetime="{ start }">{ startJa }</time> <span><fa icon="map-marker"></fa>{ location }</span> </article>', 'app-events { display: block; padding: 1em 0; text-align: left; } app-events article { text-align: left; position: relative; margin: 1em 0; padding-left: 100px; display: inline-block; width: 250px; } app-events h3 { font-size: 110%; font-weight: normal; margin: 0 0 .7em; } app-events h3 fa { font-size: 1.7em; width: 2em; height: 2em; line-height: 2em; text-align: center; color: white; background: #7992A7; position: absolute; left: .8em; top: 0; } app-events time { font-size: 90%; display: block; margin-bottom: .3em; color: #666; } app-events span { display: block; font-size: 85%; color: #666; } app-events span fa { color: #E33247; font-size: 120%; margin-right: .3em; } @media (min-width: 500px) { app-events { padding: 1em 2em; } }', function(opts) {
...
riot.tag('app-hero', '<section class="cover"></section> <header> <span>{ props.title }</span> <h1>{ props.name }</h1> <h2>{ props.kana }</h2> <ul> <li each="{ props.links }"><a href="{ url }"><fa icon="{ icon }"></fa></a></li> </ul> </header> <h3>{ props.copy }</h3> <p>{ props.desc }</p>', 'app-hero { display: block } app-hero .cover { position: absolute; z-index: -1; top: 0; width: 100%; height: 320px; background-size: cover; background-image: url(images/photo.jpg); background-position: center; } app-hero header { margin: 280px 8% 0; padding: 1.3em 2em 1.5em; position: relative; } app-hero header:before,app-hero header:after { content: \'*\'; color: transparent; background: white; position: absolute; top: 0; left: 0; right: 0; bottom: 0; z-index: -1; } app-hero header:before { bottom: 1em; box-shadow: 0 0 4px rgba(0,0,0,.5); } app-hero header span { padding: .5em 1em .3em; background: #999; color: white; font-size: 80%; } app-hero h1 { font-weight: normal; font-size: 150%; margin: .5em 0; } app-hero h2 { font-weight: normal; font-size: 90%; margin: 0; } app-hero h3 { background: #FA7373; color: white; font-size: 100%; font-weight: normal; margin: 0; padding: 1em 0 .7em; line-height: 1em; } app-hero p { margin: 0; padding: 1.3em 2em; text-align: left; background: white; } app-hero ul { padding: 0; margin: 1.5em 0 .2em; } app-hero li { display: inline-block } app-hero li a { display: block } app-hero fa { width: 1.8em; height: 1.8em; border-radius: .9em; color: white; line-height: 1.8em; font-size: 130%; margin: 0 .3em; overflow: none; background: #42729A; text-align: center; } app-hero fa[icon=twitter] { background: #55ACEE } app-hero fa[icon=facebook] { background: #415E9B } @media (min-width: 500px) { app-hero header { text-align: left; margin-left: 12%; margin-right: 12%; } app-hero ul { position: absolute; right: 1.5em; top: 2em; margin: 0; } app-hero .cover { height: 480px; } }', function(opts) {
    this.props = opts.props
